  ...
  <div className="flex flex-col h-full">
    ...
    <div className="flex items-center justify-between mb-8 bg-gray-100/50 p-4 rounded-2xl">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="w-10 h-10 rounded-full bg-brandPurple flex items-center justify-center text-white shadow-sm border-2 border-white font-bold text-xs overflow-hidden">
      ...
      {subjects.length === 0 ? (
        ...
        <div className="flex flex-col items-center">
           <div className="space-y-4 w-full max-w-4xl">
              ...
              {/* Check if any subjects match the search term */}
              {filteredSubjects.length > 0 ? (
                ...
                <div className="flex flex-col items-center py-16 bg-gray-50 rounded-[2rem] border-2 border-dashed border-gray-200 text-center">
                  <p className="text-gray-500 font-medium">No results for "{searchTerm}"</p>
                  <button 
                    onClick={() => setSearchTerm('')} 
                    className="text-brandPurple font-bold mt-2 hover:underline"
                  >
                    Clear Search
                  </button>
                </div>
